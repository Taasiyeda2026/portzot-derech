...
export const FIELD_DEFINITIONS = [
  ...
  { id: 'findings',         question: 'מה גיליתן בעקבות החקר?',              shortLabel: 'מה גילינו',       hint: 'סכמו מה למדתן, מה הבנתן, ומה היה חשוב לכן לקחת מהבדיקה אל הפתרון.',                                        maxChars: 110, align: 'right', fontSize: 42, minFontSize: 30, lineHeight: 1.3, verticalCenter: true },
