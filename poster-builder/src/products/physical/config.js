...
export const BACKGROUNDS = [
  { id: 'bg-tech1',  name: 'רקע 1',  path: '/poster-builder/assets/backgrounds/bg-tech1.svg',  orientation: 'any' },
  { id: 'bg-tech2',  name: 'רקע 2',  path: '/poster-builder/assets/backgrounds/bg-tech2.svg',  orientation: 'any' },
  { id: 'bg-tech3',  name: 'רקע 3',  path: '/poster-builder/assets/backgrounds/bg-tech3.svg',  orientation: 'any' },
  { id: 'bg-tech4',  name: 'רקע 4',  path: '/poster-builder/assets/backgrounds/bg-tech4.svg',  orientation: 'any' },
  { id: 'bg-tech5',  name: 'רקע 5',  path: '/poster-builder/assets/backgrounds/bg-tech5.svg',  orientation: 'any' },
  { id: 'bg-tech6',  name: 'רקע 6',  path: '/poster-builder/assets/backgrounds/bg-tech6.svg',  orientation: 'any' },
  { id: 'bg-tech7',  name: 'רקע 7',  path: '/poster-builder/assets/backgrounds/bg-tech7.svg',  orientation: 'any' },
  { id: 'bg-tech8',  name: 'רקע 8',  path: '/poster-builder/assets/backgrounds/bg-tech8.svg',  orientation: 'any' },
...
export const FIELD_DEFINITIONS = [
  ...
  { id: 'problem',          question: 'מה הבעיה שזיהיתן?',                  shortLabel: 'הבעיה שזיהינו',   hint: 'תארו בקצרה את הקושי, הצורך או המצב שהוביל אתכן לחפש פתרון.',                                                maxChars: 130, align: 'right', fontSize: 42, minFontSize: 30, lineHeight: 1.3, verticalCenter: true },
  { id: 'audience',         question: 'על מי הבעיה משפיעה?',                shortLabel: 'קהל היעד',        hint: 'כתבו מי קהל היעד שסובל מהבעיה או מתמודד איתה ביומיום.',                                                     maxChars: 75,  align: 'right', fontSize: 42, minFontSize: 30, lineHeight: 1.3, verticalCenter: true },
  { id: 'researchQuestion', question: 'מה הייתה שאלת החקר הטכנולוגית?',     shortLabel: 'שאלת החקר',       hint: 'נסחו את שאלת החקר שהובילה את תהליך הבדיקה, ההשוואה או התכנון.',                                             maxChars: 90,  align: 'right', fontSize: 42, minFontSize: 30, lineHeight: 1.3, verticalCenter: true },
  ...
  { id: 'findings',         question: 'מה גיליתן בעקבות החקר?',              shortLabel: 'תובנות מהחקר',       hint: 'סכמו מה למדתן, מה הבנתן, ומה היה חשוב לכן לקחת מהבדיקה אל הפתרון.',                                        maxChars: 110, align: 'right', fontSize: 42, minFontSize: 30, lineHeight: 1.3, verticalCenter: true },
