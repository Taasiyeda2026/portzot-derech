...
function App() {
  ...
  useEffect(() => {
    saveProject({ ...loadProject(), posterSize, productType, background: currentBackground, contentValues, fieldSettings, titleStyle: { fontFamily: titleFont, color: titleColor, textColor }, schoolLogoImage: schoolLogoImageRef.current || null, slotImages });
    if (wizardStep === 4) {
