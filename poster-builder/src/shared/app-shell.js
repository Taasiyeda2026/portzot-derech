...
function App() {
  ...
  return h('div',{className:'app'}, h('div',{className:'step4-wrapper',style:{display:isStep4?'flex':'none'}}, h('div',{className:'step4-bar'}, h('div',{className:'step4-bar-start'}, h('button',{className:'step4-back-btn',onClick:()=>{if(PRESELECTED_START_STEP===4){const p={physical:'./physical.html',website:'./website.html',app:'./app.html'};window.location.href=p[productType]||'./physical.html';return;} if(productType==='physical'){setPhysicalSubStep(2);} goToStep(3);}},'‹ חזרה')), h('div',{className:'step4-bar-center'},productType==='physical'?h(PhysicalStepIndicator,{current:4}):h(StepIndicator,{current:4})), h('div',{className:'step4-bar-end'}, h('button',{className:'step4-export-btn',onClick:handleExportPdf},'ייצוא PDF'), h('button',{className:'step4-finish-btn',onClick:()=>goToStep(5)},'סיום ›'))),
    h('div',{className:'step4-body'}, h('div',{className:'html-poster-area'}, h('div',{id:'poster-html',style:{width:'794px',height:'1123px',minHeight:'1123px',position:'relative',overflow:'visible',direction:'rtl',background:'#fff',display:'flex',flexDirection:'column',boxShadow:'0 16px 56px rgba(94,39,80,.2), 0 4px 16px rgba(0,0,0,.08)',flexShrink:0}}, h('div',{id:'poster-bg',style:{position:'absolute',inset:0,zIndex:0}}), h('div',{id:'poster-inner',style:{position:'relative',zIndex:1,display:'flex',flexDirection:'column',height:'1123px',minHeight:'1123px'}}, h('div',{style:{height:'5px',background:'linear-gradient(90deg,#5E2750,#d61f8c,#9b40c0,#5E2750)',flexShrink:0}}), h('div',{style:{padding:'16px 32px 10px',textAlign:'center',position:'relative',flexShrink:0}}, h('div',{style:{position:'absolute',top:'12px',right:'22px'}},h('img',{src:'/poster-builder/assets/logoposter.png',alt:'פורצות דרך',style:{height:'60px',width:'auto',objectFit:'contain',filter:'drop-shadow(0 0 4px #fff) drop-shadow(0 0 12px rgba(255,255,255,1)) drop-shadow(0 0 24px rgba(255,255,255,.95)) drop-shadow(0 0 40px rgba(255,255,255,.75)) drop-shadow(0 0 60px rgba(255,255,255,.45))'}})), h('div',{id:'ph-name',style:{fontWeight:900,lineHeight:1.1,marginBottom:'8px',wordBreak:'break-word',overflowWrap:'anywhere'}}), h('div',{id:'ph-title-line',style:{width:'52px',maxWidth:'540px',height:'3px',background:'linear-gradient(90deg,#5E2750,#d61f8c)',borderRadius:'2px',margin:'0 auto 10px'}}), h('div',{id:'ph-desc',style:{fontSize:'13px',color:'#5a3a5a',maxWidth:'500px',margin:'0 auto',lineHeight:1.45}}), h('div',{id:'ph-team',style:{background:'rgba(255,255,255,.88)',border:'1px solid rgba(94,39,80,.2)',borderRadius:'10px',padding:'6px 12px',width:'fit-content',maxWidth:'390px',margin:'7px auto 0'}},h('div',{style:{fontSize:'8px',fontWeight:700,color:'#5E2750',textTransform:'uppercase',letterSpacing:'1px',marginBottom:'4px'}},'הצוות שלנו'),h('div',{id:'ph-names',style:{fontSize:'10px',fontWeight:400,color:'#2a1a3a',lineHeight:1.65}}),h('div',{id:'ph-school',style:{fontSize:'9px',fontWeight:400,color:'#8a7aa0',lineHeight:1.45,marginTop:'3px'}}))), h('div',{id:'ph-main',style:{flex:'0 0 auto',display:'flex',flexDirection:'column',justifyContent:'flex-start',gap:'10px',padding:'0 24px 8px'}}, h('div',{style:{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'9px',flexShrink:0}}, h('div',{className:'ph-card'},h('div',{className:'ph-cap'},'הבעיה שזיהינו'),h('div',{id:'ph-problem',className:'ph-body'}),h('div',{id:'ph-audience',className:'ph-sub'})),h('div',{className:'ph-card'},h('div',{className:'ph-cap'},'שאלת החקר'),h('div',{id:'ph-rq',className:'ph-body'}))), h('div',{style:{flexShrink:0}},h('div',{id:'ph-images-label',style:{fontSize:'7.5px',fontWeight:700,color:'#5E2750',textTransform:'uppercase',letterSpacing:'1.5px',textAlign:'center',marginBottom:'7px'}}),h('div',{id:'ph-images-2',style:{display:'none',gridTemplateColumns:'1fr 1fr',gap:'10px'}},h('div',{id:'ph-img-physical-0','data-ph-img':'0','data-layout':'physical',className:'ph-img-frame',style:{height:'205px'}}),h('div',{id:'ph-img-physical-1','data-ph-img':'1','data-layout':'physical',className:'ph-img-frame',style:{height:'205px'}})),h('div',{id:'ph-images-app',style:{display:'none',gridTemplateColumns:'1fr 1fr 1fr',gap:'9px'}},h('div',{id:'ph-img-app-0','data-ph-img':'0','data-layout':'app',className:'ph-img-frame ph-notch',style:{height:'250px'}}),h('div',{id:'ph-img-app-1','data-ph-img':'1','data-layout':'app',className:'ph-img-frame ph-notch',style:{height:'250px'}}),h('div',{id:'ph-img-app-2','data-ph-img':'2','data-layout':'app',className:'ph-img-frame ph-notch',style:{height:'250px'}})),h('div',{id:'ph-images-web',style:{display:'none',gridTemplateColumns:'1fr 1fr 1fr',gap:'9px'}},h('div',{id:'ph-img-web-0','data-ph-img':'0','data-layout':'website',className:'ph-img-frame',style:{height:'145px'}}),h('div',{id:'ph-img-web-1','data-ph-img':'1','data-layout':'website',className:'ph-img-frame',style:{height:'145px'}}),h('div',{id:'ph-img-web-2','data-ph-img':'2','data-layout':'website',className:'ph-img-frame',style:{height:'145px'}}))), h('div',{style:{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'8px',flexShrink:0}},h('div',{className:'ph-card'},h('div',{className:'ph-cap'},'החקר שביצענו'),h('ul',{id:'ph-research',className:'ph-bullets'})),h('div',{className:'ph-card'},h('div',{className:'ph-cap'},'תובנות מהחקר'),h('div',{id:'ph-findings',className:'ph-body'})),h('div',{className:'ph-card'},h('div',{className:'ph-cap'},'דרישות הפתרון'),h('ul',{id:'ph-reqs',className:'ph-bullets'}))), h('div',{style:{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'9px',flexShrink:0}},h('div',{className:'ph-card'},h('div',{id:'ph-solution-cap',className:'ph-cap'}),h('div',{id:'ph-solution',className:'ph-body'})),h('div',{className:'ph-card'},h('div',{id:'ph-usage-cap',className:'ph-cap'}),h('ul',{id:'ph-usage',className:'ph-bullets'}))), h('div',{style:{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'8px',flexShrink:0}},h('div',{className:'ph-card ph-card-accent'},h('div',{className:'ph-cap'},'המשוב שקיבלנו'),h('div',{id:'ph-feedback',className:'ph-body'})),h('div',{className:'ph-card ph-card-accent'},h('div',{className:'ph-cap'},'מה שיפרנו'),h('div',{id:'ph-improved',className:'ph-body'})),h('div',{className:'ph-card ph-card-accent'},h('div',{className:'ph-cap'},'הערך המרכזי'),h('div',{id:'ph-value',className:'ph-body'})))), h('div',{id:'ph-footer',style:{background:'linear-gradient(135deg,#4a1f40,#5E2750,#9b40c0)',padding:'8px 28px',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}},h('div',{id:'ph-slogan',style:{fontStyle:'italic',fontSize:'13px',color:'rgba(255,255,255,.95)'}}),h('div',{style:{fontSize:'9.5px',color:'rgba(255,255,255,.6)',fontWeight:700,letterSpacing:'1.2px'}},'פורצות דרך ✦ 2026')))))))))),
